    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('member/user/ajax_list') ?>",
                    "type": "POST"
                },
        ...
        function save() {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('member/user/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('member/user/ajax_update') ?>";
            }
        ...
        function edit_user(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('member/user/ajax_edit') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    //console.log(data);
                    ...
                    $('#addUser').modal('show'); // show bootstrap modal when complete loaded
        ...
        function delete_user(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('member/user/ajax_delete') ?>/" + id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data) {
